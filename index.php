...
<script type="text/javascript" src="shared/js/global/ga9d07.js?20121001"></script>
    ...
    <script type="text/javascript" src="common/js/observable.js">
      <!---->
    </script>
    <script type="text/javascript" src="common/js/interactive.js">
      <!---->
    </script>
    <script type="text/javascript" src="js/top.js"></script>
    </head>
  <body id="www-ia-omron-com" class="home">
    <div class="omron-ia">
                  ...
                  <div class="index-blockH01-unit automation-systems">
                    ...
                    <div class="index-list">
                      <ul class="link-listA01">
                        ...
                        <!--
                        <li>
                          <a href="/products/category/automation-systems/multi-axis-controller/">
                            <img src="/common/img/icon_01.gif" width="3" height="9" alt="" class="iconA01">Multi-Axis Controller</a>
                        </li>
                        -->
                        <li>
...
<!-- Correction Notice -->
<div class="applications-area">
<h2><a href="products/correct/index.html"><img src="common/img/icon_01.gif" width="3" height="9" alt="" class="iconA01"/>Correction Notice</a></h2>

<div class="appli-list">
<h3><a href="products/correct/index.html"><img src="common/img/icon_01.gif" width="3" height="9" alt="" class="iconA01"/>Catalog Correction Notice</a></h3>
</div>
...
<li style="border:2px groove ;padding-left: 10px;"><a href="obsolete.html" target="_blank"><img src="resource/image/banner/obsolete model5.jpg"  alt="Say no to counterfeit products." /></a><a href="obsolete.html" target="_blank">Omron obsolete model in bangladesh<img src="common/img/icon_07.gif" width="14" height="11" alt="" class="external-win"/></a></li>
</ul>
