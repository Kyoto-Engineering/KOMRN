...
/* リスト作成 ----------------------------------*/
	this.countryWebsiteMake = function(dataJson) {
		...
		writedata += '<div id="region-list"><p class="regionHeading"><a href="javascript:void(0);"><img width="16" height="16" alt="close" src="/resources/images/icon_close.gif"></a><em>Quick links to OMRON Country Websites.</em></p>';
